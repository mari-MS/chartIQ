...
const defaultDir = path.resolve(__dirname, "src");
console.log("defaultDir", defaultDir)
// const env = process.env.NODE_ENV || "production";
// console.log("env", env);

function startWebPack(environ={}){
	const isProduction = environ.prod;
	console.log("isProduction", isProduction);
	outputDir = path.resolve(__dirname, isProduction ? "dist" : "dev");
	url = isProduction ? "https://simulator.chartiq.com/datafeed" : "https://simulator.chartiq.com/datafeed";
	return ({
	...
	plugins: [
		...
		new CopyPlugin({
			patterns: [
				{
					from: path.join(defaultDir, "js/thirdparty/html2canvas.min.js"),
